...
pragma experimental ABIEncoderV2;
 ...
 contract SDV{
	...
	enum DocType { NotExist, Education, Employment}
	...
	function addNewOrg(address _oAddress, string memory _name) external onlyOwner notRegisteredOrg(_oAddress) returns (bool success) {
		organisations[_oAddress] = Organisation(_name, State.Approved);
		return true;
	}
